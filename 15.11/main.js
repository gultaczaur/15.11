...
// 1) "users" arrayində firstname-in sonu "q" ilə bitən name varsa, logda versin yoxdursa,
// error versin, error message de "q"ile biten ad yoxdur yazilsin

// try {
//     const namesEnd = users.filter(user => user.firstName.endsWith("q"));
//     if (namesEnd.length > 0) {
//         console.log("Adlar:", namesEnd.map(user => user.firstName));
//     } else {
//         throw new Error('"q" ilə bitən ad yoxdur');
//     }
// } catch (error) {
...
// try {
//     const getData = users.filter(user => user.age > 100);
//     if (getData.length > 0) {
//         console.log("Yaşları 100 den yuxarı olan istifadəçilər:",
//             getData.map(user => user.age));
//     } else {
//         throw new Error('Yaşları 100-dən yuxarı olan istifadəçi mövcud deyil');
//     }
// } catch (error) {
//     console.error(error.message);
// } finally {
//     console.log("Bütün istifadəçilərin yaşları:", users.map(user => user.age));
// }
...
//         } else {
//             throw new Error(`İstifadeçi tapılmadı. ID:`);
//         }
//     } catch (error) {
//         console.error(error.message + id);
//     }
// }
// getUserById(13235425);
// getUserById(1);
...
// function checkAddressById(id) {
//     try {
//         const user = users.find(user => user.id === id);
//         if (user) {
//             if (user.address) {
//                 console.log("Address mövcuddur:", user.address);
//             } else {
//                 throw new Error(`Bu ID li istifadəçinin addressi mövcud deyil.`);
//             }
//         } else {
//             throw new Error(`İstifadəçi tapılmadı. ID:`);
//         }
//     } catch (error) {
//         console.error(error.message+id);
//     }
...
//                 console.log("İstifadəçi mövcuddur:", user.weight, user.height);
//             } else {
//                 throw new Error(`Bu ID li istifadəçinin weight və ya height mövcud deyil.`);
//             }
//         } else {
//             throw new Error(`İstifadəçi tapılmadı. ID:`);
//         }
